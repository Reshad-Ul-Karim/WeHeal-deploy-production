...
import { MapPinIcon, PhoneIcon, TruckIcon, CheckIcon, XMarkIcon, UserIcon, ClockIcon, CurrencyDollarIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div className="request-info-content">
                        ...
                        <p className="request-info-value">Age: {currentRequest.patientInfo?.age || 'N/A'}</p>
                      </div>
                    </motion.div>
