...
import './OxygenCylinderPayment.css';

const OxygenCylinderPayment = () => {
  ...
  const handlePaymentSuccess = async (paymentData) => {
    try {
      ...
      const orderPayload = {
        ...
        paymentType: 'oxygen_cylinder',
        transactionId: paymentData.transactionId,
        items: [{
          type: 'oxygen_cylinder',
          productId: orderData.productId || 'oxygen-cylinder',
          name: orderData.name || 'Oxygen Cylinder',
          description: orderData.description || 'Emergency oxygen cylinder delivery',
      ...
      <div className="payment-page">
        <div className="container">
          <div className="error-message">
            ...
            <button onClick={() => navigate('/emergency/oxygen-cylinder')}>
              Go Back
            </button>
          </div>
        </div>
    ...
    <div className="payment-page">
      <div className="container">
        ...
        <div className="payment-header">
          ...
          <p>Secure payment for your oxygen cylinder subscription</p>
        </div>
...
export default OxygenCylinderPayment;